...
public class MainActivity extends AppCompatActivity {
    ...
    String getXmlData() {
        ...
        String queryUrl = "http://apis.data.go.kr/1471000/DrbEasyDrugInfoService/getDrbEasyDrugList?serviceKey=" + key + "&trustEntpName=" + location + "&pageNo=1&startPage=1&numOfRows=100";
        try {
                ...
                switch (eventType) {
                    ...
                    case XmlPullParser.START_TAG:
                        ...
                        if (tag.equals("item")) ; //첫번째 검색결과
                            ...
                            buffer.append(xpp.getText());
                            buffer.append("\n");
                        } else if (tag.equals("artpWarnQesitm")) {
                            buffer.append("주의사항, 경고 : ");
                            xpp.next();
                            buffer.append(xpp.getText());
                            buffer.append("\n");
                        } else if (tag.equals("artpQesitm")) {
                            buffer.append("주의사항 : ");
                            xpp.next();
                            buffer.append(xpp.getText());
                            buffer.append("\n");
                            ...
                            buffer.append(xpp.getText());
                            buffer.append("\n");
                        } else if (tag.equals("openDe")) {
                            buffer.append("공개일자 : ");
                            xpp.next();
                            buffer.append(xpp.getText());
                            buffer.append("\n");
                        } else if (tag.equals("updateDe")) {
                            buffer.append("수정일자 : ");
                            xpp.next();
                            buffer.append(xpp.getText());
                            buffer.append("\n");
